...
##### Подготовка
````
Выбрать в .env нужый CONFIG_PATH
````
...
##### Запуск локально приложение, остальное в докере
````
Запуск в прод:
...
##### Create PVZ
````bash
curl --post301 http://localhost:9002/api/v1/pvzs -i -H 'Content-Type: application/json' -d '{
    "name": "Ozon Tech",
...
##### List of PVZs
````bash
curl http://localhost:9002/api/v1/pvzs -i
````

##### Get PVZ by ID
````bash
curl -X GET http://localhost:9002/api/v1/pvzs/id -i -H 'Content-Type: application/json' -d '{
...
##### Update PVZ
````bash
curl -X PUT http://localhost:9002/api/v1/pvzs/id -i -H 'Content-Type: application/json' -d '{
    "id": "9967bb48-bd6f-4ad0-924d-8c9094c4d8c2",
    "name": "Ozon Company",
...
##### Delete PVZ
````bash
curl -X DELETE http://localhost:9002/api/v1/pvzs/id -i -H 'Content-Type: application/json' -d '{
    "id": "9967bb48-bd6f-4ad0-924d-8c9094c4d8c2"
}'
````
...
##### Create Order
````bash
curl --post301 http://localhost:9002/api/v1/orders -i -H 'Content-Type: application/json' -d '{
...
##### List of orders
````bash
curl http://localhost:9002/api/v1/orders -i
````

##### Get order by ID
````bash
curl -X GET http://localhost:9002/api/v1/orders/id -i -H 'Content-Type: application/json' -d '{
...
##### Update order
````bash
curl -X PUT http://localhost:9002/api/v1/orders/id -i -H 'Content-Type: application/json' -d '{
    "id": "165dbe30-d0c4-4727-9504-827db76d214e",
    "client_id": "9967bb48-bd6f-4ad0-924d-8c9094c4d8c2",
    "stores_till": "2024-04-22T13:14:01Z",
    "weight": 15,
...
##### Delete order
````bash
curl -X DELETE http://localhost:9002/api/v1/orders/id -i -H 'Content-Type: application/json' -d '{
    "id": "165dbe30-d0c4-4727-9504-827db76d214e"
}'
````
...
````bash
curl -X GET http://localhost:9002/api/v1/orders/client/id -i -H 'Content-Type: application/json' -d '{
    "id": "165dbe30-d0c4-4727-9504-827db76d214e"
}'
````
...
##### Give out orders
````bash
curl -X PUT http://localhost:9002/api/v1/orders/client/id -i -H 'Content-Type: application/json' -d '{
...
##### Return order
````bash
curl -X PUT http://localhost:9002/api/v1/orders/client/id/return -i -H 'Content-Type: application/json' -d '{
